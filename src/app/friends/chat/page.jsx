          ...
          <div className="flex-1 overflow-y-auto">
            {loading ? (
              ...
              <div className="p-6 text-center text-gray-500">
                <p>No friends yet</p>
                <Link href="/friends/search" className="text-blue-500 hover:underline text-sm mt-2 block">
              ...
              friends.map((friend) => (
                ...
                >
                  <div className="relative flex-shrink-0">
                    <img
                      src={friend.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(friend.name)}&background=0D8ABC&color=fff`}
                      alt={friend.name}
                  ...
                  <div className="flex-1 text-left min-w-0">
                    <div className="flex justify-between items-baseline">
                      <h3 className={`font-semibold truncate ${friend.unreadCount > 0 ? 'text-blue-600' : ''}`}>
                        {friend.name}
                      </h3>
            ...
            <>
              ...
              <div className="p-4 bg-white border-b border-gray-200 flex items-center gap-3 shadow-sm">
                <div className="relative">
                  <img
                    src={selectedFriend.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedFriend.name)}&background=0D8ABC&color=fff`}
